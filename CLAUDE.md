...
Layer 3: CLAUDE.md       — This file. Schema, conventions, workflows.
```
...
# Filter by IDE
python3 tools/ingest-chats.py ingest --all --ide claude-code
```

**What it does:**
1. Finds conversation files from IDE storage (Claude Code, Cursor, Windsurf, Continue, Cline)
...
1. Read this file (`CLAUDE.md`) to understand the system
...
- **Any LLM IDE** — Claude Code, Cursor, Copilot, Windsurf, Cline, Aider, etc.
